...
class StoreApp extends StorebaseApp
{
	...
	//验证码
	function code($num = 4, $size = 20, $width = 0, $height = 0)
    {
		 /** 
    ...
    // 个人注册
    function reg_person(){
        $this->display('reg_person.html');
    }
	
	//注册-登录成功储存用户信息
	function user_sessions()
    {
		$_SESSION["user_info"] = $_GET;
	...
	function reg_sm()
    {
        ...
        $this->display('reg_sm.html');
    }
	//注册说明介绍
	function clc_sm()
    {
       
        $this->display('clc_sm.html');
    }
