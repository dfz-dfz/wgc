...
//            'phone_mob' => LANG::get('phone_mob'),
	...
	function types()
    {
	   ...
	   while($user = @mysql_fetch_array($qres)){
		...
		$limit = '<span style="font-size:12px;color:#999;margin-right:10px;">总共:<b  style="font-size:12px;color:#ccc">'.$totalNumber.'</b></span><div class="digg">'. $this->showPage($page,$totalNumber,10,'index.php',$params,$id).'</div>';
