...
<link href="/manage/Public/jobs/css/style.css" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript">
		...
		function dqsel(e){
			$.cookie('s_county', $(e).val());
			var vals = $.cookie('s_county');
			//alert(vals)
			<?php if(($xinzi != null) or ($xinzi != '')): ?>window.location.href="/manage/index.php/Home/Zhaopin/searchjobs/s_county/"+vals+"/xinzi/<?php echo ($xinzi); ?>"; 
			<?php else: ?> 
				window.location.href="/manage/index.php/Home/Zhaopin/searchjobs/s_county/"+vals<?php endif; ?>
			
			
		}
		function xzsel(e){
			//alert($(e).val());
			<?php if(($s_county != null) or ($s_county != '')): ?>window.location.href="/manage/index.php/Home/Zhaopin/searchjobs/xinzi/"+$(e).val()+"/s_county/<?php echo ($s_county); ?>"; 
			<?php else: ?> 
				window.location.href="/manage/index.php/Home/Zhaopin/searchjobs/xinzi/"+$(e).val();<?php endif; ?>
...
<!--内容列表-->
<div style="width:100%;mar-width:100%;">
<img src="/manage/Public/jobs/img/joblogo.png" style="width:100%;" />
</div>
<div class="aui-content aui-margin-b-15">
    <ul class="aui-list aui-list-in">
			<li class="aui-list-item">
				<div class="aui-list-item-inner">
					<div class="aui-list-item-title">
						<div style="border-right:1px solid #747474;display:inline;width:45%;height:50px;max-width:50%;float:left;margin-left:15px;">
							<select name='s_county' onchange="dqsel($(this))" id="s_county" style="display:inline;width:28%;">
								<option value="all">区域</option>
								<option value="all">不限</option>
								<?php if(is_array($s_countys)): foreach($s_countys as $key=>$area): ?><option value="<?php echo ($area["region_name"]); ?>"><?php echo ($area["region_name"]); ?></option><?php endforeach; endif; ?>
							</select><img src="/manage/Public/jobs/img/selectlogo.png">
						</div>
						<div style="border-left:1px solid #747474;display:inline;width:40%;height:50px;max-width:50%;float:left;text-align:right;margin-right:15px;">
							<select name='xinzi' onchange="xzsel($(this))" id="xinzi" style="display:inline;width:28%;">
								<option value="all">薪资</option>
								<option value="all">不限</option>
								<option value="100">面议</option>
								<option value="1000">1000元以下</option>
								<option value="2000">1000~2000</option>
								<option value="3000">2000~3000</option>
								<option value="5000">3000~5000</option>
								<option value="8000">5000~8000</option>
								<option value="12000">8000~12000</option>
								<option value="20000">12000~20000</option>
								<option value="20001">大于20000</option>
							</select><img src="/manage/Public/jobs/img/selectlogo.png">
						</div>
					</div>
				</div>
		...
		<?php if(is_array($jobs)): foreach($jobs as $key=>$job): ?><li class="aui-list-item aui-list-item-middle">
                ...
                <div class="aui-list-item-title"><a href="/manage/index.php/Home/Zhaopin/jobinfo/id/<?php echo ($job["id"]); ?>"><span style="color:#FB9541;float:right;"><?php echo ($job["xinzi"]); ?>/月</span><?php echo ($job["title"]); ?></a></div>
...
<footer class="aui-bar aui-bar-tab" id="footer">
    <div class="aui-bar-tab-item aui-active" tapmode>
        ...
        <div class="aui-bar-tab-label">返回</div>
    </div>
	<div class="aui-bar-tab-item aui-active" tapmode>
        <i class="aui-iconfont aui-icon-pencil"></i>
        <div class="aui-bar-tab-label">申请</div>
    </div>
...
<script type="text/javascript" src="/manage/Public/jobs/script/jquery.cookie.js" ></script>
<script type="text/javascript">
    apiready = function(){
        api.parseTapmode();
    }
