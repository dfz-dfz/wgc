        ...
        <div class="aui-chat-inner">
            <div class="aui-chat-content" style="background-color:#E67817;">
				...
				<table>
					<tr>
						<td>
							<div style="display:inline;width:82;"><a href="/manage/jingyi.php/Home/Jysearch/myqginfo/id/<?php echo ($job["id"]); ?>"><img src="/manage/Public/jobs/img/qg.png" style="display:inline;width:82;"></a></div>
						</td>
						<td>
							<div style="display:inline;width:282;height:120px;text-align:top;">
								<a href="/manage/jingyi.php/Home/Jysearch/myqginfo/id/<?php echo ($job["id"]); ?>"><p><?php echo ($job["title"]); ?></p>
								<p><?php echo ($job["ps"]); ?></p>
