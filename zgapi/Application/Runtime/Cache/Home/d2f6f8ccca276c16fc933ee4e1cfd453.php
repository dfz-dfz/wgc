		...
		<?php if(is_array($pjs)): foreach($pjs as $key=>$pj): ?><li class="aui-list-item">
				<div class="aui-list-item-inner">
					<div class="aui-list-item-title">
						<span>
							<span style="font-size:30px;"><a href="/manage/jingyi.php/Home/View/viewinfo/v_id/<?php echo ($pj["v_id"]); ?>"><?php echo ($pj["title"]); ?></a></span><br/>地址：<?php echo ($pj["s_province"]); echo ($pj["s_city"]); echo ($pj["s_county"]); echo ($pj["xiangxi"]); ?>
						</span>
						<span style="float:right;margin-bottom:5px;"><?php echo ($pj["fabutime"]); ?></span>
					</div>
				</div>
			</li>
