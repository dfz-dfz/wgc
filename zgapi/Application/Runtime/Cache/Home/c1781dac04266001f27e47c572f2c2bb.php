...
<link href="/zgapi/Public/jobs/css/style.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" href="/zgapi/Public/jobs/css/cityselect.css">
	<script type="text/javascript" src="/zgapi/Public/jobs/script/jquery-1.7.2.min.js" ></script>
	<script type="text/javascript">
		function goBack(){ 
		window.location.href="http://59jiaju.com/manage/jingyi.php/Home/Zhaojob/daohang";
		}
		function selectcity(){
			$("#selProvince").click();
			//alert('ok');
...
<header class="aui-bar aui-bar-nav" style="background-color:#C25423;">
	<a class="aui-pull-left aui-btn">
        <span class="aui-iconfont aui-icon-left" onclick="goBack()"></span><input style="height:20px;" type="text" class="cityinput" id="gr_zone_ids" placeholder="请输入目的地" value="<?php echo city();?>">
    </a>
...
<script type="text/javascript" src="/zgapi/Public/jobs/script/zepto.js"></script>
<script type="text/javascript">
//加载城市事件
...
$('body').on('click', '.city-list p', function () {
	...
	//alert($('#gr_zone_ids').html());//处理城市切换
	//var nowcity=$('#gr_zone_ids').html();
	var nowcity=$(this).html();
	/*$.ajax({url:"/zgapi/jingyi.php/Home/Zhaopin/ajax_city/city/"+nowcity,success:function(result){
		//alert(result);
		window.location.reload();
	}});*/
	$.post("/zgapi/jingyi.php/Home/Jysearch/ajax_city",
	  {
		name:"city",
		city:nowcity
	  },
...
<div style="width:100%;max-width:100%;">
    <table style="width:100%;max-width:100%;">
        <tr>
            <td style="width:70%;max-width:70%;text-align:center;">
              <img src="/zgapi/Public/jobs/img/uinfo.png" style="width:120px;height:120px;display:inline;float:left;"><br/>
              <span style="font-size:20px;"><?php echo ($info["user_name"]); ?></span><br/>
              <span style="font-size:10px;"><?php echo ($info["jobtypename"]); ?></span>
            </td>
            <td style="width:30%;max-width:30%;text-align:right;">
              级别：<span style="font-size:20px;"><?php echo ($info["mygrade"]); ?></span>
            </td>
        </tr>
    </table>
</div>
<div style="width:100%;max-width:100%;height:220px;position:relative;">
    <div style="position:absolute;width:100%;max-width:100%;height:220px;">
    <img src="/zgapi/Public/jobs/img/jfbjt.png" style="width:100%;max-width:100%;height:220px;">
    </div>
    <div style="position:absolute;width:30%;height:50px;margin-left:50%;margin-top:120px;">
      <?php echo ($info["jifen"]); ?>
    </div>
</div>
<div style="width:100%;max-width:100%;">
    <table style="width:100%;max-width:100%;text-align:center;">
        <tr>
            <td style="width:33%;max-width:33%;border:1px solid #838383;"><a href="/zgapi/jingyi.php/Home/Jymember/erweima">拉工友</a></td>
            <td style="width:33%;max-width:33%;border:1px solid #838383;"><a href="javascript:;" onclick="showDefault('fail')">充值</a></td>
            <td style="width:33%;max-width:33%;border:1px solid #838383;"><a href="javascript:;" onclick="showDefault('fail')">积分兑换</a></td>
        </tr>
        <tr>
            <td style="width:33%;max-width:33%;border:1px solid #838383;"><a href="/zgapi/jingyi.php/Home/Jymember/qiuzhi">发布工作</a></td>
            <td style="width:33%;max-width:33%;border:1px solid #838383;"><a href="javascript:;" onclick="showDefault('fail')">支付</a></td>
            <td style="width:33%;max-width:33%;border:1px solid #838383;"><a href="/zgapi/jingyi.php/Home/Zhaojob/daohang">接活</a></td>
        </tr>
    </table>
</div>
<div style="width:100%;max-width:100%;">
    <table style="width:100%;max-width:100%;">
        <tr>
            <td style="width:50%;max-width:50%;height:100px;"><a href="/zgapi/jingyi.php/Home/Jymember/upuinfo/user_id/<?php echo ($info["user_id"]); ?>"><img src="/zgapi/Public/jobs/img/myinfo.png" style="width:100%;max-width:100%;height:100px;"></a></td>
            <td style="width:50%;max-width:50%;height:100px;"><a href="/zgapi/jingyi.php/Home/Jymember/mygrade/user_id/<?php echo ($info["user_id"]); ?>"><img src="/zgapi/Public/jobs/img/mygrade.png" style="width:100%;max-width:100%;height:100px;"></a></td>
        </tr>
    </table>
</div>
    ...
    <ul class="aui-list aui-list-in">
        <li class="aui-list-item aui-list-item-middle">
            <div class="aui-list-item-inner aui-list-item-arrow">
                <div class="aui-list-item-title"><i class="aui-iconfont aui-icon-star"></i>&nbsp;<a href="/zgapi/jingyi.php/Home/Jysearch/myjiehuo">我的接活</a></div>
        </li>
        <li class="aui-list-item">
            <div class="aui-list-item-inner aui-list-item-arrow">
                <div class="aui-list-item-title"><i class="aui-iconfont aui-icon-star"></i>&nbsp;<a href="/zgapi/jingyi.php/Home/Jysearch/myqg">我的抢工</a></div>
            </div>
        </li>
		<li class="aui-list-item aui-list-item-middle">
            <div class="aui-list-item-inner aui-list-item-arrow">
                <div class="aui-list-item-title"><i class="aui-iconfont aui-icon-star"></i>&nbsp;<a href="/zgapi/jingyi.php/Home/Jysearch/searchadd/user_id/<?php echo ($info["user_id"]); ?>">发布工价</a></div>
        </li>
		<li class="aui-list-item aui-list-item-middle">
            <div class="aui-list-item-inner aui-list-item-arrow">
                <div class="aui-list-item-title"><i class="aui-iconfont aui-icon-star"></i>&nbsp;<a href="/zgapi/jingyi.php/Home/View/myview">我的评价</a></div>
        </li>
        <li class="aui-list-item">
            <div class="aui-list-item-inner aui-list-item-arrow">
                <div class="aui-list-item-title"><i class="aui-iconfont aui-icon-star"></i>&nbsp;<a href="/zgapi/jingyi.php/Home/Jysearch/searchjobs/huo/own">我的发布</a></div>
            </div>
        </li>
        <li class="aui-list-item">
            <div class="aui-list-item-inner aui-list-item-arrow">
                <div class="aui-list-item-title"><i class="aui-iconfont aui-icon-star"></i>&nbsp;<a href="tel:18688888888">联系客服</a></div>
            </div>
        </li>
		<!--<li class="aui-list-item">
            <div class="aui-list-item-inner aui-list-item-arrow">
                <div class="aui-list-item-title"><i class="aui-iconfont aui-icon-star"></i>&nbsp;<a href="/zgapi/jingyi.php/Home/Jymember/erweima">我的二维码</a></div>
            </div>
        </li>-->
    </ul>
</div>
<input type="hidden" id='flag' value="<?php echo ($info["have_job"]); ?>">
<div class="aui-content aui-margin-b-15">
    <ul class="aui-list aui-form-list">
        <li class="aui-list-item">
            <div class="aui-list-item-inner">
				<?php if($info['have_job'] == 0 ): ?><div class="aui-list-item-label">
						<span id="qk">离职</span>
					</div>
					<div class="aui-list-item-input">
						<input type="checkbox" class="aui-switch" style="background:#FEE240;" onchange="changestatus()">
					</div>
				<?php else: ?> 
					...
					<div class="aui-list-item-input">
						<input type="checkbox" class="aui-switch" checked onchange="changestatus()" style="background:#DD4C40;">
					</div><?php endif; ?>
...
<script type="text/javascript">
	...
	function changestatus(){
			...
			if(stu==0){
				...
				$('#flag').val(stu);
				$("#qk").html("在职");
				$(".aui-switch").css("background","#DD4C40");
			}else{
				stu=0;
				$('#flag').val(stu);
				$("#qk").html("离职");  
				$(".aui-switch").css("background","#FEE240");
			}
			$.get("http://59jiaju.com/manage/jingyi.php/Home/Jymember/changstatus", { ch: stu},
			  function(data){
