        ...
        <div class="aui-card-list-content-padded aui-border-b aui-border-t" style="width:100%;max-width:100%;">
            <div class="aui-row aui-row-padded" style="width:100%;max-width:100%;">
                <div class="aui-col-xs-4" style="width:100%;max-width:100%;">
                    <a href="/manage/index.php/Home/Company/cpinfoqbb"><img style="width:100%;max-width:100%;" src="/manage/Public/jobs/img/msg.png" /></a>
                </div>
            </div>
        </div>
            ...
            <div class="aui-list-item-inner">
                <div class="aui-list-item-title">
					<div class="aui-col-xs-4" style="width:100%;max-width:100%;display:inline;">
						<div style="width:75%;max-width:75%;display:inline;float:left;padding-top:28px;"><a href="/manage/index.php/Home/Company/cpinfoszb" style="color:#000000;">【经典套餐】428人工辅料套餐</a></div>
						<div style="width:25%;max-width:25%;display:inline;float:right;"><a href="/manage/index.php/Home/Company/cpinfoszb"><img src="/manage/Public/jobs/img/msg428.png" /></a></div>
					</div>
				</div>
            </div>
        </li>
