...
<header class="aui-bar aui-bar-nav" style="background-color:#FE7213;">
    ...
    <div class="aui-title">
			<form id="jobsfrm" action="/manage/index.php/Home/Caigou/getlist" method="get">
				<input type="text" name="title" placeholder="请输入搜索内容" id="searchjobs" style="border:1px solid #FFFFFF;background-color:#FFFFFF;width:70%;margin-top:7px;height:24px;display:inline;"><div style="display:inline;" class="aui-col-xs-3"><i onclick="tijiaofrm()" class="aui-iconfont aui-icon-search"></i></div>
			</form>
	</div>
...
<header class="aui-bar aui-bar-nav" style="background-color:#FE7213;">
    <a class="aui-pull-left aui-btn">
         <span class="aui-iconfont aui-icon-left" onclick="goBack()"></span><input style="height:20px;width:20%;max-width:20%;" type="text" class="cityinput" id="gr_zone_ids" placeholder="请输入目的地" value="<?php echo city();?>"></input>
    </a>

	<!--<span style="color:#FFFFFF;float:left;" >&nbsp;<a onclick="selectcity()" href="javascript:;"><span id='s_city'>广州</span></a></span>-->
   <div class="aui-title">
			 <!--<i onclick="tijiaofrm()" class="aui-iconfont aui-icon-search"></i>-->
			<!--<form id="jobsfrm" action="/manage/index.php/Home/Caigou/searchjobs" method="get">
				<input type="text" name="title" placeholder="请输入搜索内容" id="searchjobs" style="border:1px solid #FFFFFF;background-color:#FFFFFF;width:70%;margin-top:7px;height:24px;display:inline;">&nbsp;<i onclick="tijiaofrm()" class="aui-iconfont aui-icon-search"></i>
			</form>-->
			<i class="aui-iconfont aui-icon-search" onclick="tijiaofrm()"></i>
	</div>
	<div class="aui-searchbar" id="search" style="width:70%;max-width:70%;margin-left:30%;background:#FE7213;">
				<div class="aui-searchbar-input aui-border-radius" tapmode onclick="doSearch()">
					<i class="aui-iconfont aui-icon-search" onclick="tijiaofrm()"></i>
					<form id="jobsfrm" action="/manage/index.php/Home/Caigou/getlist" method="get" action="javascript:tijiaofrm();">
						<input type="search" name="title"  placeholder="请输入搜索内容" id="search-input"></input>
					</form>
    ...
    <ul class="aui-list aui-list-in">
			<li class="aui-list-item">
				<div class="aui-list-item-inner">
					<div class="aui-list-item-title"><span style="float:right;"><a href="/manage/index.php/Home/Caigou/getlist/more/y" style="color:#000000;">查看更多</a></span>热门职位</div>
				</div>
			</li>
		<?php if(is_array($infos)): foreach($infos as $key=>$info): ?><li class="aui-list-item aui-list-item-middle">
				<div class="aui-list-item-inner aui-list-item-arrow">
                <div class="aui-list-item-title"><a href="/manage/index.php/Home/Caigou/cginfo/id/<?php echo ($info["id"]); ?>"><span style="color:#FB9541;float:right;"><?php echo ($info["addtime"]); ?></span><?php echo ($info["title"]); ?></a></div>
