    ...
    var phonenum=$("#phone_mob").val();
        if(phonenum==""){
            ...
            alert('请输入11位的手机号');
             ...
             $.ajax({
               type: "POST",
                url: "/zgapi/jingyi.php/Home/Zhaojob/getveryfy",
  ...
  function myveryfy(){
    var veryfy=$("#veryfy").val();
        if(veryfy==""){
            //alert("手机号不能为空");
             ...
             $.ajax({
               type: "POST",
                url: "/zgapi/jingyi.php/Home/Zhaojob/veryfy",
                data: "veryfy="+veryfy,
                success: function(msg){
                        if(msg=='ok'){
                            $("#vf").val('ok'); 
	...
	function checkemail(){
		...
		if(email==""){
			...
			$.ajax({
               type: "POST",
                url: "/zgapi/jingyi.php/Home/Zhaojob/isemal",
                data: "email="+email,
                success: function(msg){
                        if(msg=='ok'){
                            $('#em').val('ok');
	...
	function checkname(){
		...
		if(user_name==""){
			...
			$.ajax({
               type: "POST",
                url: "/zgapi/jingyi.php/Home/Zhaojob/checkname",
...
<header class="aui-bar aui-bar-nav" style="background-color:#3BB3C3;">
    ...
    <div class="aui-title" ><span style="float:right;"><a href="/zgapi/jingyi.php/Home/Zhaojob/register">注册</a><span></div>
</header>
...
<form id='myregform' action="/zgapi/jingyi.php/Home/Zhaojob/login" method="post">
...
<div style="width:100%;max-width:100%;">
 	<p style="text-align:right;"><a href="/zgapi/jingyi.php/Home/Zhaojob/setpwd">忘记密码</a></p>
</div>
<div class="aui-content-padded">
 	<p style="background-color:#3BB3C3;"><div class="aui-btn aui-btn-warning aui-btn-block" onclick="tijao()" >登　录</div></p>
</div>
