...
<div class="aui-content aui-margin-b-15">
    <ul class="aui-list aui-list-in">
		<?php if(is_array($dianzhu)): foreach($dianzhu as $key=>$dian): ?><li class="aui-list-item aui-list-item-middle">
				<div class="aui-list-item-inner aui-list-item-arrow">
                <div class="aui-list-item-title"><span style="float:right;">店主：<?php echo ($dian["user_name"]); ?><br/>电话：<?php echo ($dian["phone_mob"]); ?></span><span style="font-size:30px;">卫浴五金店</span><br/><span>地址：<?php echo ($dian["xiangxi"]); ?></span></div>
