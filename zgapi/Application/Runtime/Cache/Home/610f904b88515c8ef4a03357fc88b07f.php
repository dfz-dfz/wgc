...
<img style="width:100%;" src="/manage/Public/jobs/img/sm21.png">
<img style="width:100%;" src="/manage/Public/jobs/img/sm22.png">
</div>-->
<link rel="stylesheet" type="text/css" href="/manage/Public/jobs/css/aui-slide.css" />
<div id="aui-slide3">
    <div class="aui-slide-wrap" >
        <div class="aui-slide-node bg-dark">
            <img src="/manage/Public/jobs/img/sm21.png" />
        </div>
        <div class="aui-slide-node bg-dark">
            <img src="/manage/Public/jobs/img/sm22.png" />
        </div>
