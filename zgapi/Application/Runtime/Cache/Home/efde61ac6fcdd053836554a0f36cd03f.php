...
<img style="width:100%;" src="/manage/Public/jobs/img/sm11.png">
<img style="width:100%;" src="/manage/Public/jobs/img/sm12.png">
<img style="width:100%;" src="/manage/Public/jobs/img/sm13.png">
</div>-->
<link rel="stylesheet" type="text/css" href="/manage/Public/jobs/css/aui-slide.css" />
<div id="aui-slide3">
    <div class="aui-slide-wrap" >
        <div class="aui-slide-node bg-dark">
            <img src="/manage/Public/jobs/img/sm11.png" />
        </div>
        <div class="aui-slide-node bg-dark">
            <img src="/manage/Public/jobs/img/sm12.png" />
        </div>
        <div class="aui-slide-node bg-dark">
            <img src="/manage/Public/jobs/img/sm13.png" />
        </div>
    </div>
