...
<div class="aui-content aui-margin-b-15">
    <ul class="aui-list aui-list-in">
        ...
        <li class="aui-list-item">
         ...
         <li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-title"><span style="color:#B4B4B4;">维修时效：<?php echo ($info["livetime"]); ?></span></div>
            </div>
        </li>
        <li class="aui-list-item">
            <div class="aui-list-item-inner">
				<div class="aui-list-item-title"><span style="color:#B4B4B4;">备  注</span><br/><?php echo ($info["ps"]); ?></div>
            </div>
			
        </li>
    </ul>
</div>
<!--<div class="aui-content-padded" style="text-align:center;" id='jiehuo'>
