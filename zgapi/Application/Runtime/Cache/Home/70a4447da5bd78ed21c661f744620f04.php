...
<header class="aui-bar aui-bar-nav" style="background-color:#FE7213;">
   ...
   <div class="aui-title">
			...
			<!--<form id="jobsfrm" action="/manage/index.php/Home/Zhaopin/searchjobs" method="get">
	...
	<div class="aui-searchbar" id="search" style="width:70%;max-width:70%;margin-left:30%;background:#FE7213;">
				<div class="aui-searchbar-input aui-border-radius" tapmode onclick="doSearch()">
					<i class="aui-iconfont aui-icon-search" onclick="tijiaofrm()"></i>
					<form id="jobsfrm" action="/manage/index.php/Home/Zhaopin/searchjobs" method="get" action="javascript:tijiaofrm();">
...
<div style="width:100%;max-width:100%;">
	<div class="aui-searchbar" id="search">
		<div class="aui-searchbar-input aui-border-radius" tapmode onclick="doSearch()">
			<i class="aui-iconfont aui-icon-search" onclick="tijiaofrm()"></i>
			<form id="jobsfrm" action="/manage/index.php/Home/Zhaopin/searchjobs" method="get" action="javascript:tijiaofrm();">
				<input type="search" name="title" id="searchjobs" placeholder="请输入搜索内容" id="search-input">
			</form>
		</div>
		<div class="aui-searchbar-cancel" tapmod>取消</div>
	</div>
...
<script type="text/javascript">
//加载城市事件
$('body').on('click', '#zone_ids,#gr_zone_ids,#loan_jm_l1', function () {
	var zid = $(this).attr('id');
	$('.container').show();

});
//选择城市 start  'click', '#zone_ids,#gr_zone_ids'loan_jm_l1
    ...
    <ul class="aui-list aui-list-in">
			<li class="aui-list-item">
				<div class="aui-list-item-inner">
					<div class="aui-list-item-title"><span style="float:right;"><a href="/manage/index.php/Home/Zhaopin/getjobs/more/y" style="color:#000000;">查看更多</a></span>热门职位</div>
				</div>
			</li>
