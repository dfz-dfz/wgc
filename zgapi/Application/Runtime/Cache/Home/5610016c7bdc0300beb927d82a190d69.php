...
<head>
    ...
    var phonenum=$("#phone_mob").val();
        if(phonenum==""){
            ...
            alert('请输入11位的手机号');
             ...
             $.ajax({
               type: "POST",
                url: "/zgapi/jingyi.php/Home/Jymember/getveryfy",
  ...
  function myveryfy(e, pnumber){
    var veryfy=$(e).val();
             ...
             $.ajax({
               type: "POST",
                url: "/zgapi/jingyi.php/Home/Jymember/veryfy",
                data: "veryfy="+veryfy,
                success: function(msg){
						//alert(msg);
                        if(msg=='ok'){
	...
	function checkemail(){
		...
		if(email==""){
			...
			$.ajax({
               type: "POST",
                url: "/zgapi/jingyi.php/Home/Jymember/isemal",
                data: "email="+email,
                success: function(msg){
                        if(msg=='ok'){
							//alert('ok');
	...
	function checkname(){
		...
		if(user_name==""){
			...
			$.ajax({
               type: "POST",
                url: "/zgapi/jingyi.php/Home/Jymember/checkname",
	...
	function checktel(){
		...
		if(phone_mob==""){
			...
			$.ajax({
               type: "POST",
                url: "/zgapi/jingyi.php/Home/Jymember/checktel",
    ...
    function tijao(){
        ...
        if(user_name==""){
			...
			/*$.ajax({
				cache: true,
				type: "POST",
				url:"/zgapi/jingyi.php/Home/Jymember/upuinfo",
				...
				async: false,
				  ...
				  success: function(data) {
					...
					if(data=="uperr"){
						...
						//alert(user_id);
						window.location.href="/zgapi/jingyi.php/Home/Jymember/userinfo/user_id/"+user_id; 
					}
				   //alert(data);
				  }
			  });*/
...
<form id='myregform' action="/zgapi/jingyi.php/Home/Jymember/qiuzhi" method="post">
...
<div class="aui-content aui-margin-b-15">
     <ul class="aui-list aui-form-list">
        ...
        <li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-input">
                    <input id="education" name='data[education]' type="text" placeholder="|学历" value="<?php echo ($info["education"]); ?>">
                </div>
            </div>
        </li>
        <li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-input">
                    <input id="graduate" name='data[graduate]' type="text" placeholder="|毕业学校" value="<?php echo ($info["graduate"]); ?>">
                </div>
            </div>
        </li>
         <li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-input">
                    <textarea id="certificate" name='data[certificate]' placeholder="|证书" ><?php echo ($info["certificate"]); ?></textarea>
                </div>
            </div>
        </li>
        <li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-input">
                    <input id="position" name='data[position]' type="text" placeholder="|职业" value="<?php echo ($info["position"]); ?>">
                </div>
            </div>
        </li>
        <li class="aui-list-item">
		...
		<li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-input">
                    <textarea id="skill" name='data[skill]' placeholder="|技能特长" ><?php echo ($info["skill"]); ?></textarea>
                </div>
            </div>
        </li>
        <li class="aui-list-item">
		...
		<li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-input">
                    <textarea id="job_live" name='data[intension]' placeholder="|求职意向" ><?php echo ($info["intension"]); ?></textarea>
                </div>
            </div>
        </li>
     </ul>
