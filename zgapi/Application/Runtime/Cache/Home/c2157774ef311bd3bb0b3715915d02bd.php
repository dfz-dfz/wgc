    ...
    <ul class="aui-list aui-list-in">
			<li class="aui-list-item">
				<div class="aui-list-item-inner">
					<div class="aui-list-item-title"><span style="float:right;"><a href="/manage/index.php/Home/Search/jobslist/more/y" style="color:#000000;">查看更多</a></span>招聘以下职位</div>
				</div>
			</li>
		<?php if(is_array($jobs)): foreach($jobs as $key=>$job): ?><li class="aui-list-item aui-list-item-middle">
				<div class="aui-list-item-inner aui-list-item-arrow">
                <div class="aui-list-item-title"><a href="/manage/index.php/Home/Search/jobinfo/id/<?php echo ($job["id"]); ?>"><span style="color:#FB9541;float:right;"><?php echo ($job["xinzi"]); ?></span><?php echo ($job["title"]); ?></a></div>
