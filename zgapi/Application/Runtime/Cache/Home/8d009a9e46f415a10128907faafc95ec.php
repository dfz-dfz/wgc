...
<header class="aui-bar aui-bar-nav" style="background-color:#FE7213;">
    ...
    <div class="aui-title">
			59行业装饰平台<i class="aui-iconfont aui-icon-search"></i>
	</div>
...
<!--内容列表-->
<?php
$i=1; $start='<div class="aui-content aui-margin-b-15"><ul class="aui-list aui-form-list">'; $end='</ul></div>'; $item='<li class="aui-list-item"><div class="aui-list-item-inner">'; foreach($cps as $key=>$row){ $flag=$i%4; if($flag===0){ $item.='</div></li><li class="aui-list-item"><div class="aui-list-item-inner"><div class="aui-list-item-label"><a href="/manage/index.php/Home/Company/storeinfo/id/'.$row['id'].'">'.$row['gname'].'</a></div>'; $i++; }else{ $item.='<div class="aui-list-item-label"><a href="/manage/index.php/Home/Company/storeinfo/id/'.$row['id'].'">'.$row['gname'].'</a></div>'; } $i++; } $flag=$i%4; if(!$flag){ $item.='</div></li>'; } echo $start.$item.$end; ?>
	<!--装饰公司 装饰公司
		机电安装 机电公司
		消防 消防公司
		保洁 保洁公司
