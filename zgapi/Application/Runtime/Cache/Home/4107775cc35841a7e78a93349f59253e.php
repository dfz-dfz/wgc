...
<link rel="stylesheet" href="/manage/Public/jobs/css/cityselect.css">
	...
	<script type="text/javascript">
		...
		function dqsel(e){
			//alert($(e).val());
			<?php if(($xinzi != null) or ($xinzi != '')): ?>window.location.href="/manage/index.php/Home/Company/searchjobs/s_county/"+$(e).val()+"/xinzi/<?php echo ($xinzi); ?>"; 
			<?php else: ?> 
				window.location.href="/manage/index.php/Home/Company/searchjobs/s_county/"+$(e).val();<?php endif; ?>
			
		}
		function xzsel(e){
			//alert($(e).val());
			<?php if(($s_county != null) or ($s_county != '')): ?>window.location.href="/manage/index.php/Home/Company/searchjobs/xinzi/"+$(e).val()+"/s_county/<?php echo ($s_county); ?>"; 
			<?php else: ?> 
				window.location.href="/manage/index.php/Home/Company/searchjobs/xinzi/"+$(e).val();<?php endif; ?>
...
$('body').on('click', '.city-list p', function () {
	...
	/*$.ajax({url:"/manage/index.php/Home/Zhaopin/ajax_city/city/"+nowcity,success:function(result){
		//alert(result);
		window.location.reload();
	}});*/
	$.post("/manage/index.php/Home/Zhaopin/ajax_city",
	  {
		name:"city",
		city:nowcity
	  },
...
<style type="text/css">
.aui-content{width:100%;max-width:100%;}
.aui-content ul,.aui-content ul li,.aui-content ul li .aui-list-item-inner,.aui-content ul li .aui-list-item-inner .aui-list-item-title{width:100%;max-width:100%;}
.aui-content ul li .aui-list-item-inner .aui-list-item-title span{width:80px;max-width:25%;background-color:red;margin-left:10px;}
</style>
<!--内容列表-->
		...
		<li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('装饰公司'); ?>" >装饰公司</a>
                </div>
				<div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('机电安装');?>" >机电公司</a>
                </div>
				<div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('消防');?>">消防公司</a>
                </div>
				<div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('保洁');?>">保洁公司</a>
                </div>
            </div>
        </li>
		<li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('厨具');?>">厨具公司</a>
                </div>
				<div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('环保');?>">环保公司</a>
                </div>
				<div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('办公家具');?>">家具公司</a>
                </div>
				<div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('软装');?>">软装公司</a>
                </div>
            </div>
        </li>
		<li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('防鼠');?>">防鼠/防蚁</a>
                </div>
				<div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('幕墙');?>">幕墙公司</a>
                </div>
				<div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('路政');?>">路政公司</a>
                </div>
				<div class="aui-list-item-label">
                   <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('园林');?>">园林公司</a>
                </div>
            </div>
        </li>
		<li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('材料');?>">材料公司</a>
                </div>
				<div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('招牌');?>">招牌公司</a>
                </div>
				<div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('维修');?>">维修公司</a>
                </div>
				<div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('拆除');?>">拆除公司</a>
                </div>
            </div>
        </li>
		<li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('智能化');?>">智能化公司</a>
                </div>
				<div class="aui-list-item-label">
                    <a href="/manage/index.php/Home/Company/morestore/gtype/<?php echo base64url_encode('建筑加固');?>">建筑加固公司</a>
                </div>
				<div class="aui-list-item-label">
