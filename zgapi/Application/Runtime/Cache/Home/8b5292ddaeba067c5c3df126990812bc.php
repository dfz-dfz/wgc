    ...
    <ul class="aui-list aui-list-in">
			<li class="aui-list-item">
				<!--<div class="aui-list-item-inner">
					<div class="aui-list-item-title" style="width:100%;"><span style="width:33%;"><a href="/manage/jingyi.php/Home/Jysearch/searchjobs/jobtype/<?php echo ($jobtype); ?>">接活|</a></span><span style="width:33%;">抢工|</span><span style="width:33%;"><a href="/manage/jingyi.php/Home/Jysearch/searchjobs/jobtype/<?php echo ($jobtype); ?>/huo/own">自己发布的活</a></span></div>
				</div>-->
				<div class="aui-list-item-inner">
