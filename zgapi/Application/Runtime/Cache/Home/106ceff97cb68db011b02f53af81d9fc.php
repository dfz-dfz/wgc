				...
				async: false,
				  ...
				  success: function(data) {
					...
					if(data=="uperr"){
						...
						//alert(data);
						window.location.href="/manage/jingyi.php/Home/Zhaojob/register/step/2/user_id/"+data; 
					}
				   //alert(data);
				  }
			  });
        ...
        <li class="aui-list-item">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-input">
                    <input id='real_name' name='data[real_name]' type="text" placeholder="|请输入真实姓名">
                </div>
            </div>
        </li>
        <li class="aui-list-item">
...
<div class="aui-content-padded">
    <p><div class="aui-btn aui-btn-primary aui-btn-block" onclick="tijao()">确认提交</div></p>
</div>
<div style="width:100%;max-width:100%;">
<img src="/manage/Public/jobs/img/regfoot.png" style="width:100%;" />
</div>
</body>
