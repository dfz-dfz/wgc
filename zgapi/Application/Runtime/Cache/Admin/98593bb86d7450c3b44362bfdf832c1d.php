...
function daoru(){
	$.get("/duanxin/index.php/Admin/Mobile/daochu", function(result){
		$("#receive_num").val(result);
	});
}
</script>
</head>
<body>
<div style="width:100%;text-align:center;"><span><a onclick="daoru()" href="javascript:;" style="color:red;">导入通讯录</a></span></div>
<article class="page-container">
	<form action="/duanxin/index.php/Admin/Content/contentadd" method="post" class="form form-horizontal" id="form-content-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<textarea  style="resize: none;width:800px;height:80px;" placeholder="号码间使用英文逗号(,)隔开" id="receive_num" name="receive_num" datatype="*4-16" nullmsg="接收号码不能为空"></textarea>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<textarea  style="resize: none;width:800px;height:300px;" placeholder="短信内容" id="content" name="content" datatype="*4-16" nullmsg="短信内容不能为空"></textarea>
			</div>
		</div>
		<div class="row cl">
...
function tijiao(){
		...
		cache: true,
		type: "POST",
		url:"/duanxin/index.php/Admin/Content/contentadd",
