...
<article class="page-container">
	<form action="/manage/index.php/Admin/Jobtype/typeadd" method="post" class="form form-horizontal" id="form-type-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>工种称谓：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="工种称谓" id="jobtype_name" name="jobtype_name" datatype="*4-16" nullmsg="工种称谓不能为空">
			</div>
		</div>
		<div class="row cl">
...
function tijiao(){
		...
		cache: true,
		type: "POST",
		url:"/manage/index.php/Admin/Jobtype/typeadd",
