		...
		<div>
			...
			<div class="page-content" >
				<div class="page-header" style="width:100%;height:45px;padding-top:12px;">
					<form action="/manage/index.php/Admin/Jobtype/typelist" method="get" >
						工种称谓：<input  type="text" name="jobtype_name" placeholder="工种称谓" value="<?php echo ($_GET['jobtype_name']); ?>" />
								&nbsp;&nbsp;
						时间：
						...
						<button type="submit" class="btn btn-xs btn-primary">搜索</button>　　　<span style="background-color:#428BCA;font-size:17px;margin-bottom:0px;"><a href="javascript:;" style="color:#FFFFFF;" onclick="type_add('添加类型','/manage/index.php/Admin/Jobtype/typeadd','800')">添加</a></span>
					</form>
				</div><!-- /.page-header -->
				<div class="row">
					<form action="<?php echo U('Admin/Jobtype/typedel');?>" method="post" id="formids">
						...
						<tbody>
							<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
								<td class="center" width="80px">
									<label>
										<input type="checkbox"  name="jobtype_id[]" value="<?php echo ($v["jobtype_id"]); ?>"/>
										<!--<span class="lbl"></span>-->
									</label>
								</td>

								<th><?php echo ($v["jobtype_id"]); ?></th>
								<th><?php echo ($v["jobtype_name"]); ?></th>
								...
								<td width="100px">
									<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
										...
										<a class="blue" onClick="type_edit('编辑','<?php echo U('Admin/Jobtype/typeupdate',array('jobtype_id'=>$v['jobtype_id']));?>','800')" href="javascript:;">
											<!--<i class="icon-edit bigger-130"></i>-->编辑
										</a>

										<a class="red" onclick="return type_del('<?php echo U('Admin/Jobtype/typedel',array('jobtype_id'=>$v['jobtype_id']));?>')" href="javascript:;">
							...
							<tr>
								<td colspan="2">
									<input type="button" value="删除" onclick="return type_delmall('<?php echo U('Admin/Jobtype/typedel');?>')" style="background-color:#F70808;" />
								</td>
								<td colspan="7">
