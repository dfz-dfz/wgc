...
function change1(v){
	...
	with(ss){
		length = 0;
		options[0]=new Option(opt10[v],opt10[v]);
...
function change2(v){
	...
	with(ss){
		length = 0;
		options[0]=new Option(opt20[v],opt20[v]);
...
var b=["s_province1","s_city1","s_county1"];
var c=["s_province2","s_city2","s_county2"];
var opt0 = ["省份","地级市","市、县级市"];
var opt10 = ["省份","地级市","市、县级市"];
var opt20 = ["省份","地级市","市、县级市"];//初始值
...
function _init_area1(){  //初始化函数
	for(i=0;i<b.length-1;i++){
	  document.getElementById(b[i]).onchange=new Function("change1("+(i+1)+")");
	}
	change1(0);
}
function _init_area2(){  //初始化函数
	for(i=0;i<c.length-1;i++){
	  document.getElementById(c[i]).onchange=new Function("change2("+(i+1)+")");
	}
	change2(0);
}