...
(function ($) {
    ...
    $.fn.headshrinker = function (options) {
        var defaults = {
            ...
            menuSwitch:10, // aimed at the mobile experience, when menu is this width, convert to hamburger
        ...
        return this.each(function () {
            ...
            function headShrinker() {
                ...
                $window.load(function() {
                    ...
                    jQuery(headShrink).css( 'background' , '#fff' );
                    jQuery(headShrink).addClass( 'header-non' );
